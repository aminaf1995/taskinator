...
var taskFormHandler = function (event) {
  ...
  //check if task is new or one being by seeing if it has a data-task-id attribute
...
var editTask = function(taskId) {
    ...
    //write the values of taskname and tasktype to form to be edited
    document.querySelector("input[name='task-name']").value = taskName;
    document.querySelector("select[name='task-type']").value = taskType;

    //set data attribute to the form with the value of the task's id so it knows which one is being edited
...
var deleteTask = function(taskId) {
    ...
    for (var i = 0; i <tasks.length; i++) {
        // if tasks[i].id doesn't match the value of taskId, let's keep that task and push it into the neww array
        if (tasks[i].id !==parseInt(taskId)) {
